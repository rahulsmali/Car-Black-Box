...
void main(void)
{
    ...
    while(1)
    {
        ...
        speed = (unsigned char) (read_adc(0x00) / 10);
        if(speed > 99)
        {
            speed = 99;
        }
        ...
        else if((key == 0x2F || key == 0x37) && screen_flag == 0x01)
        {
            screen_flag = 0x03;
            reset_flag = 0x13;
            clear_screen();
        ...
        switch(screen_flag)
        {
            ...
            case 0x02:
                       ...
                       if(reset_flag == 0x12 || first_entry)
                        {
                            TMR2ON = 1;
                            return_time = 5;
                            clear_screen();
                       ...
                       menu_pos = menu_screen(reset_flag, key);
                         ...
                         if(read_digital_keypad(0) != 0x3F)
                          {
                             return_time = 5;
                         }

                      if(screen_flag == 0x02 && (key == 0xB7 || key == 0xAF))
                      {
                          TMR2ON = 0;
                          first_entry = 1;
                          return_time = 5;
                          ...
                          while(read_digital_keypad(1) != 0x3F);
